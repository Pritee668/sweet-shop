// Proper ESM Jest mock
jest.mock("../models/Sweet.js", () => {
	return {
		__esModule: true,
		default: jest.fn(), // constructor: new Sweet()
		find: jest.fn(), // Sweet.find(...)
		findById: jest.fn(), // Sweet.findById(...)
		findByIdAndUpdate: jest.fn(), // Sweet.findByIdAndUpdate(...)
		findByIdAndDelete: jest.fn(), // Sweet.findByIdAndDelete(...)
	};
});
